...
class StrategyNet:
    ...
    def __init__(
        ...
        Args:
            transactioncore: Transaction Core instance.
            marketmonitor: Market Monitor instance.
            safetynet: Safety Net instance.
            apiconfig: API configuration instance.
        """
        self.transactioncore: Optional["TransactionCore"] = transactioncore
