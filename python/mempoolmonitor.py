...
class MempoolMonitor:
    ...
    def __init__(
        ...
        Args:
            ...
            noncecore: Nonce Core instance.
            apiconfig: API Config instance.
    ...
    async def _estimate_profit(self, tx, function_params: Dict[str, Any]) -> Decimal:
        ...
        try:
            ...
            # Ensure 'path' is present in function_params to get token address
    ...
    async def _log_transaction_details(self, tx, is_eth=False) -> None:
        try:
            ...
            logger.debug(
                f"Error logging transaction details for {tx.hash.hex()}: {e}", exc_debug=True # Include traceback
            )
